...
Refs:
1. 山田育矢、鈴木正敏、山田康輔、李凌寒 (2023) 「大規模言語モデル入門」技術評論社
2. https://github.com/ghmagazine/llm-book/tree/main/chapter05
"""
...
def main() -> None:
    ...
    def tokenize_function(examples: Dict[str, Any]):
        return tokenizer(examples["sentence"], max_length=512, truncation=True, padding=False, return_tensors=None)

...
tokenizer.pad_token_id = tokenizer.eos_token_id  # Llamaはpad_tokenが設定されていないためEOSで代用 (これでいいのか？)
...
dpo_trainer = DPOTrainer(model, args=dpo_config, train_dataset=encoded_train_dataset, eval_dataset=encoded_dev_dataset)
